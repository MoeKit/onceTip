define(function (require, exports, module) {
    var $ = window.jQuery;
    var onceTip;
    var cookieStorage = require('moe/cookieStore/0.0.8/cookieStore');
    var currentHost = document.location.host,
        mainHost = document.location.host.split('.').splice(1).join('.'),
        currentDomainName = document.location.host.split('.').splice(0, 1);
